...
if ($rsEmail->rowCount() > 0){
	echo '
		<span style="color:#b94a48; font-size:13px; padding:5px 0 0 0;">Email address already registered - Please try another.</span>
		<input type="hidden" id="email_test" name="email_test" value="">
	';
	die();
}
