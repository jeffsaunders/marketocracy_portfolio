...
if ($username == ""){
	echo '
		...
		<input type="hidden" id="username_test" name="username_test" value="Username cannot be blank.">
	';
	die();
}
...
if (stripos($username, " ") !== false){
	echo '
		...
		<input type="hidden" id="username_test" name="username_test" value="Username cannot contain spaces - Please try another.">
	';
	die();
}
...
if (strlen($username) < $_SESSION['username_minimum_length']){
	echo '
		...
		<input type="hidden" id="username_test" name="username_test" value="Username must be at least '.$_SESSION['username_minimum_length'].' characters - Please try another.">
	';
	die();
}
...
if (!ctype_alnum($username)){
	echo '
		...
		<input type="hidden" id="username_test" name="username_test" value="Username must contain only letters and numbers - Please try another.">
	';
	die();
}
...
if ($rsOldUsername->rowCount() > 0){
	echo '
		...
		<input type="hidden" id="username_test" name="username_test" value="Username unavailable - Please try another.">
	';
	die();
}
	...
	while ($obscenity = $rsObscenities->fetch(PDO::FETCH_ASSOC)){
		...
		if (stripos($username, $sBad) !== false){
			echo '
				...
				<input type="hidden" id="username_test" name="username_test" value="Username contains an obscene phrase - Please try another.">
			';
			die();
		}
