...
if($indexPrice != "0.00") {
	$query = "
		...
		SET	index_djia=:index_djia,
			timestamp=UNIX_TIMESTAMP()
	";
	try {
		$rsUpdate = $mLink->prepare($query);
		$aValues = array(
			':index_djia'	=> $updateIndex,
		);
...
?>
<div class="title"><strong>Dow Jones Industrial Average</strong> <br/><small>.INX - <?php echo date('M j g:i:s A');?> EST</small></div>
