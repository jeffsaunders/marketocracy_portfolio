var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        $('#img1').click(function(e) {
          ...
          jcrop_api.setImage('plugins/jcrop/demos/demo_files/sago.jpg'); // assets/ removed
        ...
        $('#img2').click(function(e) {
          ...
          jcrop_api.setImage('plugins/jcrop/demos/demo_files/pool.jpg'); // assets/ removed
          jcrop_api.setOptions({ bgOpacity: .6 });
          return false;
        });
        $('#img3').click(function(e) {
          ...
          jcrop_api.setImage('plugins/jcrop/demos/demo_files/sago.jpg',function(){ // assets/
            this.setOptions({
              bgOpacity: 1,
              outerImage: 'plugins/jcrop/demos/demo_files/sagomod.jpg' // assets/
            });
