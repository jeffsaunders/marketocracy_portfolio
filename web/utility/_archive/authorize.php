...
// Sample code to show how to create various records
	...
	require('../../secure/authorize/authorizenet.cim.class.php');
	require('../../secure/authorize/authorize_cim_lib.php');
...
// Update payment profile (card)
	$customerProfileId = "36317278";
	$customerPaymentProfileId = "32848688";
	$firstName = "Jeff";
	$lastName = "Saunders";
	$address = "217 Creekside Drive";
	$city = "Murphy";
...
// Get payment profile (card) information
	$customerProfileId = "31848666";
	$customerPaymentProfileId = "28786176";
...
// Transaction request (charge a card)
	$customerProfileId = "1200256020";
	$customerPaymentProfileId = "1200187994";
	$order_invoiceNumber = "1234567";
	$order_description = "Marketocracy Pro Membership";
	$itemID = "PREMIUM";
	$itemName = "Annual Pro Membership Fee";
