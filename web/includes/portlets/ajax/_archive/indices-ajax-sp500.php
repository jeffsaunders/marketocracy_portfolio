...
//Fund Symbols
try{
	$rsSP500 = $mLink->prepare($query);
	$aValues = array(
		':member_id' => $_SESSION['member_id']
	);
	$preparedQuery = str_replace(array_keys($aValues), array_values($aValues), $query); //Debug
	$rsSP500->execute($aValues);
}
...
$SP500 = $rsSP500->fetch(PDO::FETCH_ASSOC);

$indexArray = explode('|', $SP500['index_SP500']);
...
<div class="stats-overview stat-block">
    ...
    <div class="details">
        <div class="title"><strong>S&amp;P 500</strong><!-- - <?php echo date('g:i:s');?> --><br/><small>.INX - <?php echo $timeUpdated;?></small></div>
