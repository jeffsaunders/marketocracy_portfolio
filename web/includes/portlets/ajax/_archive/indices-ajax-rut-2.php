...
//Fund Symbols
try{
	$rsRUT = $mLink->prepare($query);
	$aValues = array(
		':member_id' => $_SESSION['member_id']
	);
	$preparedQuery = str_replace(array_keys($aValues), array_values($aValues), $query); //Debug
	$rsRUT->execute($aValues);
}
...
$RUT = $rsRUT->fetch(PDO::FETCH_ASSOC);

$indexArray = explode('|', $RUT['index_rut']);
...
<div class="stats-overview stat-block">
    ...
    <div class="details">
        <div class="title"><strong>Russell 2000</strong><br/><small>.RUT - <?php echo $timeUpdated;?></small></div>
