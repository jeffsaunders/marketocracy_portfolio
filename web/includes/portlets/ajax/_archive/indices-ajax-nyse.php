...
//Fund Symbols
try{
	$rsNYSE = $mLink->prepare($query);
	$aValues = array(
		':member_id' => $_SESSION['member_id']
	);
	$preparedQuery = str_replace(array_keys($aValues), array_values($aValues), $query); //Debug
	$rsNYSE->execute($aValues);
}
...
$NYSE = $rsNYSE->fetch(PDO::FETCH_ASSOC);

$indexArray = explode('|', $NYSE['index_nyse']);
...
<div class="stats-overview stat-block">
    ...
    <div class="details">
        <div class="title"><strong>NYSE</strong><br/><small>.NYA - <?php echo $timeUpdated;?></small></div>
