...
$delayed = false;
if (isMarketOpen(time(), false)){
	if (time() - strtotime($timeUpdated) > 1800){
		$delayed = true;
	}
}
?>
<div class="stats-overview stat-block">
    ...
    <div class="details">
        <div class="title"><strong>Dow Jones</strong><?php echo ($delayed ? " <strong style='color:#FF0000;'>*DELAYED</strong>" : "");?><br/><small>.DJI - <?php echo $timeUpdated;?></small></div>
