...
try{
	...
	$aValues = array(
		':member_id'		=> $_REQUEST['ticket_member_id']
	);
...
$subject = $user['name_first'].', Corporate Action Change Request | CASE: '.$case['ticket_id'].' | Ticker: '.$_REQUEST['stock_ticker'].'';
$message = '
<!DOCTYPE html>
<html>
<head>
...
<table width="600" align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0px auto;" bgcolor="#ffffff">
    ...
    <tr>
        ...
        <td valign="top" colspan="2" bgcolor="#ffffff" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; line-height:20px;">
            <h2 style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#242527; margin:0px; padding:0px;"><strong>'.$user['name_first'].', we have responded to your ticket!</strong></h2>
            <p>'.$fullName.' has responded to your ticket: '.$_REQUEST['ticket_id'].'. To view and reply to our response, please login and access your ticket.</p>
    
            <p>We have provided the response for easy viewing here:</p>
            ...
            <table cellspacing="0" cellpadding="5" border="1" width="570" bordercolor="#8a8a8a">
            	<tr>
                    ...
                    <td>'.$_REQUEST['ticket_id'].'</td>
                </tr>
                
                
                <tr>
                	<td colspan="2" bgcolor="#242527"><strong style="color:#ffffff; font-size:12px;">Response:</strong></td>
                </tr>
                <tr>
                	<td colspan="2">'.$_REQUEST['reply'].'</td>
                </tr>
