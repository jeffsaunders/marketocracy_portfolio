...
$subject = $user['name_first'].', Help Desk - Marketocracy | CASE: '.$case['ticket_id'].'';
$message = '
<!DOCTYPE html>
<html>
<head>
...
<table width="600" align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0px auto;" bgcolor="#ffffff">
    <tr bgcolor="#00bdee">
		<td colspan="4" align="left" width="600" style="background-image:url(\'http://inside.marketocracy.com/email/2014/helpdesk-system-email/images/header.png\'); background-repeat:no-repeat;">
		<!--[if gte mso 9]>
		<img src="http://inside.marketocracy.com/email/2014/helpdesk-system-email/images/header.png" width="600" height="45" border="0" alt="" />
		<![endif]-->
		<!--[if !mso]><!-- -->
    ...
    <tr>
        ...
        <td valign="top" colspan="2" bgcolor="#ffffff" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; line-height:20px;">
            <h2 style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#242527; margin:0px; padding:0px;"><strong>'.$user['name_first'].', thank you for submitting a support ticket!</strong></h2>
            <p>We understand that issues and problems with your account can be frustrating and impact the performance of your model funds. For this reason, we are dedicated to responding and resolving account and fund issues promptly.</p>
    
            <p>Please keep this email for your records:</p>
    		
            <table cellspacing="0" cellpadding="5" border="1" width="570" bordercolor="#8a8a8a">
            	<tr>
                	<td bgcolor="#242527" width="200"><strong style="color:#ffffff; font-size:14px;">Case Number:</strong></td>
                ...
                <tr>
                	<td bgcolor="#242527"><strong style="color:#ffffff; font-size:14px;">Problem Type:</strong></td>
                    <td>'.$problem['label'].'</td>
                </tr>
				<tr>
...
// Additional headers
$headers .= 'From: ALPHA - Marketocracy <info@marketocracy.com>' . "\r\n";
