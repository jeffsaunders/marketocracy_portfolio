...
<table width="600" align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0px auto;" bgcolor="#ffffff">
    ...
    <tr bgcolor="#00bdee">
        ...
        <td><h2 style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#ffffff; margin:0px 0px 3px 0px; padding-top:10px; padding-bottom:5px;">Verified Performance</h2></td>
    ...
    <tr bgcolor="#242527">
		...
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#ffffff; text-align:center;padding:0px;">&copy; 2001-'.date("Y").' MyTrackRecord.com - A Product of Marketocracy Inc. | <a href="https://'.$_SESSION['base_url'].'includes/email/tracking.php?[SUB_LINK]" style="color:#ffffff;text-decoration:underline;">Change Subscription Settings</a></p>
        </td>
        <td width="15"><!--[if !mso]><!-- -->
            <img src="https://'.$_SESSION['base_url'].'includes/email/images/system-email/spacer.gif" width="15" border="0" alt="Marketocracy" />
            <!--<![endif]--></td>
