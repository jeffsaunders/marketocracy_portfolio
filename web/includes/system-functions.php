...
function sendTestEmail($mLink, $aEmail, $aEmailVars){
	...
	$headers  = 'MIME-Version: 1.0' . "\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	$headers .= 'Bcc: '.$_SESSION['test_bcc_email'].'' . "\r\n";
...
function generateArticleCampaign($mLink, $aArticle){
	
	$memberID	= $_SESSION['member_id'];
	$tempID 	= '23';
	$campType	= 'standard_campaign';
	$articleText	= addslashes($aArticle['article_text']);
	
	$emailBody	= '<br><p>'.$articleText.'</p><br><p style="text-align:center;"><a href="'.$aArticle['aritcle_link'].'" target="_blank" rel="" title="'.$aArticle['article_title'].'" style="background-color:#00bdee;padding:10px;color:#ffffff;">Finish reading on Forbes</a></p><br>';
	...
	try{
		...
		$aValues = array(
			...
			':camp_type'		=> $campType,
			':camp_status'		=> 'draft',
			':camp_name'		=> $aArticle['camp_name'].' Article '.date('Ymd'),
			':temp_id'			=> $tempID,
			':email_title'		=> $aArticle['camp_name'].' Article '.date('Ymd'),
			':email_subject'	=> 'Just Published: '.$aArticle['article_title'],
			':email_headline'	=> $aArticle['article_title'],
			':email_body' 		=> $emailBody,
			':recipient_list'	=> $aArticle['camp_list']
		);
		$preparedQuery = str_replace(array_keys($aValues), array_values($aValues), $query); //Debug
...
function sendEmail($mLink, $aEmail, $aEmailVars, $createCampaign=true, $sendEmail=true){
	...
	$headers  = 'MIME-Version: 1.0' . "\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
//	$headers .= 'Bcc: outbound@marketocracy.com' . "\r\n";
        $headers .= 'Bcc: outbound@marketocracy.net' . "\r\n";
						...
						if($memberActive == '1' || $memberID == 'test' || $skipActiveCheck == true){
							...
							if(!in_array($emailID, $aIgnoreEmails)){
								...
								if($tempID == '21'){
									...
									//get ranks for members
									$query = "
										SELECT * 
										FROM `rank_report_pro` 
										WHERE member_id=:member_id AND as_of_date=:rank_date
									";
									try{
										$rsGetRankings = $mLink->prepare($query);
										$aValues = array(
											':member_id'		=> $memberID,
											':rank_date'		=> $_SESSION['rank_date']
										);
										$preparedQuery = str_replace(array_keys($aValues), array_values($aValues), $query); //Debug
										$rsGetRankings->execute($aValues);
									}
									...
									$rankError = $error;
									while($getRanks = $rsGetRankings->fetch(PDO::FETCH_ASSOC)){
										...
										$fundSymbol	= $getRanks['fund_symbol'];
										$fundName	= $getRanks['fund_name'];
										
										$asOfDate	= explode('/',$getRanks['asOfDate']);
										
										if($getRanks['aar_10'] != NULL){$has10 = true;}
										$aBench10 	= explode('-',$getRanks['bench_10']);
										$bench10	= $aBench10[0];
										$bench10AAR	= $aBench10[1];
										switch($bench10){
											case 'gold'		: $bench10img = '<img src="https://portfolio.marketocracy.com/images/badges/Gold-10Year.png" width="40" height="40" />'; break;
											case 'silver'	: $bench10img = '<img src="https://portfolio.marketocracy.com/images/badges/Silver-10Year.png" width="40" height="40" />'; break;
											case 'bronze'	: $bench10img = '<img src="https://portfolio.marketocracy.com/images/badges/Bronze-10Year.png" width="40" height="40" />'; break;
											case '10'		: $bench10img = '<img src="https://portfolio.marketocracy.com/images/badges/10Year.png" width="40" height="40" />'; break;	
										}
										
										if($getRanks['aar_5'] != NULL){$has5 = true;}
										$aBench5 	= explode('-',$getRanks['bench_5']);
										$bench5		= $aBench5[0];
										$bench5AAR	= $aBench5[1];
										switch($bench5){
											case 'gold'		: $bench5img = '<img src="https://portfolio.marketocracy.com/images/badges/Gold-5Year.png" width="40" height="40" />'; break;
											case 'silver'	: $bench5img = '<img src="https://portfolio.marketocracy.com/images/badges/Silver-5Year.png" width="40" height="40" />'; break;
											case 'bronze'	: $bench5img = '<img src="https://portfolio.marketocracy.com/images/badges/Bronze-5Year.png" width="40" height="40" />'; break;
											case '5'		: $bench5img = '<img src="https://portfolio.marketocracy.com/images/badges/5Year.png" width="40" height="40" />'; break;	
										}
										
										if($getRanks['aar_3'] != NULL){$has3 = true;}
										$aBench3 	= explode('-',$getRanks['bench_3']);	
										$bench3		= $aBench3[0];
										$bench3AAR	= $aBench3[1];
										switch($bench3){
											case 'gold'		: $bench3img = '<img src="https://portfolio.marketocracy.com/images/badges/Gold-3Year.png" width="40" height="40" />'; break;
											case 'silver'	: $bench3img = '<img src="https://portfolio.marketocracy.com/images/badges/Silver-3Year.png" width="40" height="40" />'; break;
											case 'bronze'	: $bench3img = '<img src="https://portfolio.marketocracy.com/images/badges/Bronze-3Year.png" width="40" height="40" />'; break;
											case '3'		: $bench3img = '<img src="https://portfolio.marketocracy.com/images/badges/3Year.png" width="40" height="40" />'; break;	
										}
										
										if($getRanks['aar_1'] != NULL){$has1 = true;}
										$aBench1 	= explode('-',$getRanks['bench_1']);
										$bench1		= $aBench1[0];
										$bench1AAR	= $aBench1[1];
										switch($bench1){
											case 'gold'		: $bench1img = '<img src="https://portfolio.marketocracy.com/images/badges/Gold-1Year.png" width="40" height="40" />'; break;
											case 'silver'	: $bench1img = '<img src="https://portfolio.marketocracy.com/images/badges/Silver-1Year.png" width="40" height="40" />'; break;
											case 'bronze'	: $bench1img = '<img src="https://portfolio.marketocracy.com/images/badges/Bronze-1Year.png" width="40" height="40" />'; break;
											case '1'		: $bench1img = '<img src="https://portfolio.marketocracy.com/images/badges/1Year.png" width="40" height="40" />'; break;	
										}
										
										if($has10 == true){
											$show10 = $bench10img.'</td> <td style="border-right:2px solid #8F8F8F;"><strong>'.number_format($getRanks['aar_10'],2,'.',',').'%</strong>';
										}else{
											$show10 = '-</td><td style="border-right:2px solid #8F8F8F;">';	
										}
										
										if($has5 == true){
											$show5 = $bench5img.'</td> <td style="border-right:2px solid #8F8F8F;"><strong>'.number_format($getRanks['aar_5'],2,'.',',').'%</strong>';
										}else{
											$show5 = '-</td><td style="border-right:2px solid #8F8F8F;">';	
										}
										
										if($has3 == true){
											$show3 = $bench3img.'</td> <td style="border-right:2px solid #8F8F8F;"><strong>'.number_format($getRanks['aar_3'],2,'.',',').'%</strong>';
										}else{
											$show3 = '-</td><td style="border-right:2px solid #8F8F8F;">';	
										}
										
										if($has1 == true){
											$show1 = $bench1img.'</td> <td><strong>'.number_format($getRanks['aar_1'],2,'.',',').'%</strong>';
										}else{
											$show1 = '-</td><td>';	
										}
										
										$myRanks[$getRanks['fund_id']] = array(
											'show10'				=> $show10,
											'show5'				=> $show5,
											'show3'				=> $show3,
											'show1'				=> $show1,
											'AAR10'				=> $getRanks['aar_10'],
											'AAR5'				=> $getRanks['aar_5'],
											'AAR3'				=> $getRanks['aar_3'],
											'AAR1'				=> $getRanks['aar_1'],
											'member_id'			=> $memberID,
											...
											'fund_name'			=> $fundName,
											'exclude'			=> $getRanks['exclude'],
											'composite'			=> $getRanks['composite'],
											'bench_10'			=> $bench10img,
											'bench_5'			=> $bench5img,
											'bench_3'			=> $bench3img,
											'bench_1'			=> $bench1img,
											'bench_10_aar'		=> $bench10AAR,
											'error'				=> 'test-'.$getRanks['fund_id'].'|'.$memberID.'|'.$_SESSION['rank_date'].'|'.$preparedQuery
										);
									...
									$rankTable = '
										...
										<table cellpadding="8" style="border:2px solid #8F8F8F;border-collapse: collapse;">
											<thead>
												<tr bgcolor="#5bc0de" style="background-color:#5bc0de;color:#ffffff;border:2px solid #8F8F8F;">
													<th style="border:2px solid #8F8F8F;">Fund</th>
													<th style="border:2px solid #8F8F8F;" colspan="2">10 Year AAR</th>
													<th style="border:2px solid #8F8F8F;" colspan="2">5 Year AAR</th>
													<th style="border:2px solid #8F8F8F;" colspan="2">3 Year AAR</th>
													<th style="border:2px solid #8F8F8F;" colspan="2">1 Year AAR</th>
												</tr>
											</thead>
											<tbody>
									...
									foreach($myRanks as $fundID=>$rankInfo){
										
										$rankTable .= '
											<tr style="border-bottom:2px solid #8F8F8F;">
												<td valign="middle" style="border-right:2px solid #8F8F8F;">'.$rankInfo['fund_symbol'].'</td>
												<td valign="middle">'.$rankInfo['show10'].'</td>
												<td valign="middle">'.$rankInfo['show5'].'</td>
												<td valign="middle">'.$rankInfo['show3'].'</td>
												<td valign="middle">'.$rankInfo['show1'].'</td>
											</tr>
										';
									...
									$sendMessage 	= str_replace('[RANK_TABLE]', $rankTable, $sendMessage);
										
								}//END if ranking template
...
//					$headers2 	.= 'Bcc: outbound@marketocracy.com' . "\r\n";
                                        $headers2       .= 'Bcc: outbound@marketocracy.net' . "\r\n";
...
function subscription($mLink, $memberID, $force=false, $queryOnly=false){
	...
	//$memberData				= new member($dbPortfolio, $dbFeed, $memberID);
	...
	if($dbYear == true){
		...
		while($yearLoop){
			...
			if($select != NULL){
				...
				$html .= '<option value="'.$loopYear.'" '.$checked.'>'.$loopYear.'</option>';
			}else{
...
function tradesCheck($mLink, $fundID, $symbol, $fundSymbol=false, $split=false, $apiType='1'){
	...
	while($trades = $rsTrades->fetch(PDO::FETCH_ASSOC)){
		...
		if(date('Ymd',$trades['timestamp']) == date('Ymd')){
	...
	if($checkLoop == 0){
		...
		$aMethodVars[] = array(
			'method'		=> 'tradesForPosition',
			'source'		=> 'Fund Stratification Basic | fund-strat-basic-processes.php | function: tradesCheck',
			'api'			=> $apiType,
			'port'			=> '',
