...
Supporting files:
	AJAX		- process/ajax/fund-strat-basic-processes-new.php
	JAVASCRIPT	- THIS DOCUMENT includes/scripts/fund-strat-basic-new.js.php 
	HTML		- includes/pages/fund-strat-basic-new.php
*/


$processLink = 'process/ajax/fund-strat-basic-processes-new.php';
?>
<script>
...
function loadPriceChart(symbol, target){
	$(function () {
		...
		$.getJSON('<?php echo $processLink;?>?process=2&symbol='+symbol, function (data) {
...
function loadTickets(fundID,symbol){
	$.ajax({
        ...
        url: '<?php echo $processLink;?>?process=3-1',
...
function stockInfoTrade(type) {
    ...
    $.ajax({
        ...
        url: "<?php echo $processLink;?>?process=6&type="+type,
        success: function(data)
        {
...
function loadStockTrade() {
	$.ajax({
		//data: {fund:fundID,symbol:symbol},
      	url: '<?php echo $processLink;?>?process=5',
      	success: function(data) {
...
function loadStockTickets(){
	...
	$.ajax({
		//data: {fund:fundID,symbol:symbol},
      	url: '<?php echo $processLink;?>?process=4-1',
      	success: function(data) {
...
/*function loadPD(fundID,getSymbol){
	...
	$.ajax({
      ...
      url: '<?php echo $processLink;?>?process=1',
      success: function(data) {
...
function loadStockInfo(symbol){
	...
	$.ajax({
		data: {symbol: symbol},
      	url: '<?php echo $processLink;?>?process=4',
      	success: function(data) {
...
function loadTicketDetail(uid, fundID){
	$.ajax({
		data: {uid: uid, fund: fundID},
      	url: '<?php echo $processLink;?>?process=3',
      	success: function(data) {
