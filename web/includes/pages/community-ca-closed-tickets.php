                   ...
                   <div class="actions">
                      <div class="btn-group" id="column-view">
                         ...
                         <div id="open_tickets_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                            ...
                            <label><input type="checkbox" checked data-column="5" />Replies</label>
                ...
                <div class="portlet-body">
                        ...
                        <tbody>
                        	<?php 
							 ...
							 $query = "
								SELECT lo.label, st.ticket_status, st.ticket_id, st.ticket_type, st.ticket_subject, st.problem_type, st.description, st.timestamp, st.member_id, st.anonymous
							...
							while($ticket = $rsTickets->fetch(PDO::FETCH_ASSOC)) {
								...
								/*if($unread['replys'] != "0"){
									$ticketURL = "process/ajax/support-processes.php?process=7&ticket=".$ticket['ticket_id']."&user=member&closed=1&ca=1";	
								}else{
									$ticketURL = "?page=08-01-cc-003&ticket=".$ticket['ticket_id']."&closed=1&ca=1";	
								}*/
								$ticketURL = "?page=04-02-cc-003&ticket=".$ticket['ticket_id']."&closed=1";
								
								$memberName = get_member($mLink, $ticket['member_id'], 'full name');
								
								if($ticket['anonymous'] == "1"){
									if($_SESSION['admin'] == "1"){
										$submittedBy = 'Anonymous<br />('.$memberName.')';
									}else{
