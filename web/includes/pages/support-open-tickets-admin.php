                ...
                <div class="portlet-body">
                        ...
                        <tbody>
							...
							while($ticket = $rsTickets->fetch(PDO::FETCH_ASSOC)) {
								...
								?>
                                <tr>
                                	<td><?php echo date('m/d/Y', $ticket['timestamp']); ?><br><?php echo date('h:i a', $ticket['timestamp']); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" id="us-btn1-<?php echo $ticket['ticket_id'];?>" class="btn btn-<?php echo $showLabel; ?> btn-sm"><?php echo $ticket['label']; ?></button>
                                            <button type="button" id="us-btn2-<?php echo $ticket['ticket_id'];?>" class="btn btn-<?php echo $showLabel; ?> btn-sm dropdown-toggle" data-toggle="dropdown"><i class="icon-angle-down"></i></button>
                                    ...
                                    <td>
                                    	<div class="btn-group">
                                    		<button class="btn btn-info btn-sm" id="assign<?php echo $ticket['ticket_id'];?>">
												<?php if($ticket['assigned_to'] == ""){echo "Unassigned";}else{ echo get_member($mLink, $ticket['assigned_to'], "full name");}?>
                                            </button>
                                    		<button type="button" class="btn btn-info dropdown-toggle btn-sm" data-toggle="dropdown"><i class="icon-angle-down"></i></button>
