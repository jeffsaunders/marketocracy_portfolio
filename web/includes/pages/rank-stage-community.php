...
while($ranks = $rsRanks->fetch(PDO::FETCH_ASSOC)){
	...
	$query = "
		SELECT mf.fund_name, mf.fund_symbol, m.name_first, m.name_last, m.username
		FROM members_fund mf, members m
		WHERE mf.fund_id=:fund_id AND mf.member_id=m.member_id
	";
	try{
										...
										$fullName	= $aRank['full_name'];
											...
											if($displayRecord == true){	
												...
												<tr>
													...
													<td <?php echo $addStyle;?>><a href="?page=04-00-00-001&member=<?php echo $memberID;?>" <?php echo $linkStyle;?> target="_blank"><?php echo $fullName;?></a></td>
