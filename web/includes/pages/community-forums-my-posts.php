...
$query = "
	...
	WHERE topic_id=:topic_id AND post_creator=:member_id
...
?>
        ...
        <div class="row">
            <div class="col-md-12">
             	<a class="btn btn-info btn-sm bump-down" href="?page=04-01-00-007"><i class="icon-arrow-left"></i> Back to My Topics</a>
                <!-- BEGIN RECENT ORDERS TABLE-->
                <div class="portlet" id="ledger-entries">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-comments"></i>My Posts (<?php echo $numPosts;?>)</div>
                        <div class="actions">
                        	<a class="btn btn-info btn-sm" href="javascript:void(0);" onClick="markRead();">Mark All Posts As Read</a>
                        </div>
                    </div>
                    <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-full-width" id="my-posts">
                            <thead>
                                <tr>
                                    <th width="1%"></th>
                                    <th>Post</th>
                                    ...
                                    <th width="10%">Replies To This Post</th>
                                    <th width="10%">Replys After This Post</th>
                                </tr>
                            </thead>
                            <tbody class="load-my-posts">
                                <?php 
                                ...
                                while($post = $rsPosts->fetch(PDO::FETCH_ASSOC)) {
									...
									$topicReplys		= get_post_topic_replies($mLink, $topicID, $postDate);
									...
									if($topicReplys != "0"){
                                        $topicReplys = '<span class="label label-success">'.$topicReplys.'</span>';
                                    }else{
                                        $topicReplys = '<span class="label label-warning">'.$topicReplys.'</span>';	
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><?php echo $topicReplys;?></td>
                                    </tr>
                                    <?php
                                }
                                ?>
