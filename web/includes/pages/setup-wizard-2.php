...
<!--														<input type="text" class="form-control" name="country" value="<?php echo $member['country']; ?>" />-->
														<select name="country" id="country" class="select2 form-control" onBlur="showStates('country='+this.value);">
															<option value=""></option>
															<optgroup>
...
//			document.getElementById("email-check-result").innerHTML = '<span style="color:#3a87ad; font-size:13px;">Checking Email . . .<span>';
//alert(params);
//document.getElementById("state-field").selectedIndex = 0;
...
//alert(document.getElementById("state").value);
			...
			xmlhttp.open("GET","/process/ajax/populate-states.php?"+params);
			xmlhttp.send();
			xmlhttp.onreadystatechange = function(){
				...
				// Turn it red if it's invalid, turn red off if fixed
//				if (document.forms["register-form"].elements['email_test'].value == ""){
//					document.getElementById("email-div").classList.add("is-invalid");
//				}else{
//					document.getElementById("email-div").classList.remove("is-invalid");
//				}
			}
		}
	</script>
												...
												<div class="form-group">
													...
													<span class="help-block"></span>
														...
														<script>showStates('<?php echo "country=XX|".trim($member['country']); ?>');</script>
