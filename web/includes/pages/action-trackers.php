                            ...
                            <div class="tab-pane <?php if($tab == ""){?>active<?php } ?>" id="<?php echo $tab;?>" >
                            	<div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="portlet">
                                            <div class="portlet-title">
                                                <div class="caption">Trackers</div>
                                                <div class="actions">
                                                    <?php /*?><a class="btn btn-info btn-xs" href="#email-campaign" data-toggle="modal">New Contact</a><?php */?>
                                                </div><!--tools-->
                                            </div><!--portlet-title-->
                                            <div class="portlet-body" style="background: #FAFAFA;">
                                            	...
                                            	<table class="table table-striped table-bordered table-hover table-full-width" id="trackers_table">
                                                    <thead>
                                                        <tr>
                                                            <th width="1%">#</th>
                                                            <th>Name</th>
                                                            <th>List</th>
                                                            <th>Tracked Funds</th>
                                                            <th>Manager Updates</th>
                                                            <th>Article Updates</th>
                                                            <th>Frequency</th>
                                                            <th>Signed Up</th>
                                                            <?php /*?><th>Actions</th><?php */?>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="load-trackers">
                                        ...
                                        <?php /*?><div class="portlet">
                                            <div class="portlet-title">
                                                <div class="caption">Email Lists</div>
                                                <div class="actions">
                                                    <a class="btn btn-info btn-xs" href="#articles" data-toggle="modal">New List</a>
                                                </div><!--tools-->
                                            </div><!--portlet-title-->
                                            <div class="portlet-body" style="background: #FAFAFA;">
                                            	...
                                            	<table class="table table-striped table-bordered table-hover table-full-width" id="lists_table">
                                                    <thead>
                                                        <tr>
                                                            <th width="1%">#</th>
									 ...
									 $trackerCode = get_member($mLink, $_SESSION['member_id'], 'trackerCode');
									 
									 if($trackerCode == NULL){
											$trackerCode = strtoupper($_SESSION['username']); 
									 }
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php /*?><div class="portlet">
                                            <div class="portlet-title">
                                                <div class="caption">Your Tracker Code</div>
                                                
                                            </div><!--portlet-title-->
                                            <div class="portlet-body" style="background: #FAFAFA;">
                                            	
                                                <div id="save-tracker-code-error"></div>
												
                                            	<form action="" method="post" name="edit-tracker-code-form" class="edit-tracker-code-form">
                                                	
                                                    <div id="subdomain-error"></div>
                                                    <div class="form-group">
                                                    	<label class="control-label">Desired Tracker Code</label><br />
                                                        <input type="text" class="form-control" name="tracker_code" id="code-check" style="width:300px;display:inline;" value="<?php echo $trackerCode;?>" />
                                                    </div>
                                                    <div  id="show-subdomain-check" style="margin-top:5px !important;"></div>    
                                                      
                                                    <div id="save-tracker-btn">    
                                                    <input type="submit" value="Save Code" id="submit-tracker-code" class="btn btn-info btn-sm" />
                                                    </div>
                                                    
                                                </form><!--send email-->   
                                                
                                            	<div class="note note-info" style="margin-top:10px;">
                                                	<p>Use this code to give to your potential prospects to use when they signup to track your fund. This will allow you to view their information after they sign up.</p>
                                                    
                                                    <p>By default the code is your username, you may change it to a code of your choosing.</p>
                                                </div>
