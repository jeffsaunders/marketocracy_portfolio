...
define('TZN_DB_HOST','192.168.111.211');
define('TZN_DB_USER','marketocracy');       // edit here
define('TZN_DB_PASS','KfabyZcbE3');           // edit here
define('TZN_DB_BASE','tasks');  // edit here
...
define('FRK_VERSION_RELEASE','2007-02-25');
...
define('FRK_DEFAULT_DATEDIFF_MODE','day');	// day or diff
...
// tasks   : 6:create new, 7:edit any, 8:change status, 9:delete any
...
// misc #1 : 11:create own tasks, 12:view internal tasks,13:n/a
// misc #2 : 14:edit any task, 15:system settings

define('FRK_PROJECT_LEADER',count($GLOBALS['confProjectRights'])); // don't touch this
