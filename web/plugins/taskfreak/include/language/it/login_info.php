...
<ul style="margin:-10px 0px 0px 40px;padding:0px">
  <li>Non hai fatto il login o la sessione e' scaduta</li>
  <li>Hai inserito una password non corretta?
  <?php
  if (@constant('PRJ_PASSWORD_REMINDER')) {
  ?>
  <a href="user_password.php">Richiedina una per email</a></li>
  <?php
  }
  ?>
  <li>Il tuo browser non supporta il javascript</li>
