TaskFreak! Multi Users 0.5.7
============================
Released: February, the 25th, 2007
...
[code]
define('FRK_VERSION','0.5.7');
define('FRK_VERSION_RELEASE','2006-02-25');
[/code]
...
// others  : create own tasks/view internal tasks/-/edit any task/system settings
...
If you move the include folder from its original location, you may need to edit
...
If you moved the include/ folder (step 2.) you might have to modify the line 58:
...
If you are installing TaskFreak! under windows (for the server part), you can move
directly to next step.

If you are under a unix-like operating system (linux, macosx, etc...) you might
...
Of course you need to change /path/to/webroot/ with the real path, and taskfreak/ 
