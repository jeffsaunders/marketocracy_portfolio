-- 
-- Table structure for table `frk_country`
-- 

DROP TABLE IF EXISTS `frk_country`;
...
-- 
-- Dumping data for table `frk_country`
-- 
...
-- 
-- Table structure for table `frk_item`
-- 

DROP TABLE IF EXISTS `frk_item`;
...
-- 
-- Table structure for table `frk_itemComment`
-- 

DROP TABLE IF EXISTS `frk_itemComment`;
...
-- 
-- Dumping data for table `frk_itemComment`
-- 
...
-- 
-- Table structure for table `frk_itemFile`
-- 

DROP TABLE IF EXISTS `frk_itemFile`;
...
-- 
-- Dumping data for table `frk_itemFile`
-- 
...
-- 
-- Table structure for table `frk_itemStatus`
-- 

DROP TABLE IF EXISTS `frk_itemStatus`;
...
INSERT INTO `frk_itemStatus` VALUES (1, 1, '2006-05-02 17:35:41', 0, 1);
INSERT INTO `frk_itemStatus` VALUES (2, 2, '2006-05-02 17:36:00', 0, 1);
INSERT INTO `frk_itemStatus` VALUES (3, 3, '2006-05-02 17:37:30', 0, 1);

-- --------------------------------------------------------

-- 
-- Table structure for table `frk_member`
-- 

DROP TABLE IF EXISTS `frk_member`;
...
-- 
-- Dumping data for table `frk_member`
-- 

INSERT INTO `frk_member` VALUES (1, 'admin@taskfreak.com', 'Mr', 'Admin', '', 'Istrator', '', '', '', '', 'FR', '', '', '', 'admin', '', '12345678', 0, 7200, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2006-05-02 19:29:17', '0000-00-00 00:00:00', 0, 0, 4, '', 1, 1);

-- --------------------------------------------------------

-- 
-- Table structure for table `frk_memberProject`
-- 

DROP TABLE IF EXISTS `frk_memberProject`;
...
-- 
-- Dumping data for table `frk_memberProject`
-- 
...
-- 
-- Table structure for table `frk_project`
-- 

DROP TABLE IF EXISTS `frk_project`;
...
-- 
-- Table structure for table `frk_projectStatus`
-- 

DROP TABLE IF EXISTS `frk_projectStatus`;
...
INSERT INTO `frk_projectStatus` VALUES (1, 1, '2006-05-02 17:35:41', 0, 1);
